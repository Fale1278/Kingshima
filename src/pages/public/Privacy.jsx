    ...
    <div className={styles.pageWrapper}>
      ...
      <section style={{ padding: '4rem 5%', maxWidth: '800px', margin: '0 auto', color: 'var(--text-secondary)', lineHeight: '1.8' }}>
        ...
        <p style={{ marginBottom: '2rem' }}>
          We collect information that you explicitly provide to us when registering for the Kingshima Dashboard, applying for a mentorship program, or subscribing to our newsletter. This includes your name, email address, logic, and professional interests.
        </p>
        ...
        <div style={{ marginTop: '3rem', padding: '1.5rem', background: 'var(--surface)', borderRadius: '12px', border: '1px solid var(--border)', textAlign: 'center' }}>
          <p>If you have any questions, you can reach out via our <Link to="/contact" style={{ color: 'var(--accent-primary)', textDecoration: 'underline' }}>Contact Form</Link>.</p>
        </div>
      </section>
    </div>
  );
